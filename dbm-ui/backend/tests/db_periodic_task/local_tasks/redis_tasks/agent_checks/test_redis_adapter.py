...
class TestRedisClusterSelector:
    ...
    def test_skip_reports_use_normal_window(self, redis_adapter, base, ai_tasks):
        ...
        _create_report(
            1,
            f"{ai_tasks.SKIP_REPORT_MSG_PREFIX} maxmemory-policy=allkeys-lru enables eviction",
            now,
        )
        _create_report(
            2,
            f"{ai_tasks.SKIP_REPORT_MSG_PREFIX} maxmemory-policy=volatile-lru enables eviction",
